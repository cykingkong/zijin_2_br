...
<template>
    <div class="market relative overflow-hidden pb-20px">
        ...
        <div class="px-24px">
            ...
            <div class="search w-full rounded-12px bg-#F8F9FD flex py-9 px-16 flex items-center gap-12px mb-16"
                @click="toSearch">
        ...
        <div class="search-mark w-full h-100vh min-h-100vh bg-#fff absolute transition-all transition-delay-1300 top-[-1000] left-0 z-1000"
            v-if="searchMarkShow" :class="{ 'top-0': searchMarkShow }" @click="searchMarkShow = false">
        </div>
    </div>
</template>
