    ...
    <div class="language-page">
        ...
        <div class="bankAccount px-24 pt-20px ">
            ...
            <div class="cell-box flex flex-col gap-16px">
                <div v-for="(item, index) in languageColumns" :key="index"
                    @click="activeRadio = index; langChange(item)" :class="item.value == locale ? 'cell-active' : ''"
                    ...
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <rect x="3.33337" y="3.33301" width="13.3333" height="13.3333" rx="6.66667" fill="#6B39F4" />
                    </svg>
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"
                        v-show="item.value != locale">
