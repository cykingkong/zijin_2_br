      ...
      <div class="custom-tabs">
        ...
        <div v-if="active === 0" class="tab-content">
          <div class="discont-list flex flex-col pb-40">
            ...
            <div class="skeleton 1 w-full h-170 rounded-10px bg-coolgray skeleton-animation mt-12px"
        ...
        <div v-if="active === 1" class="tab-content">
          <div class="discont-list flex flex-col pb-40">
            ...
            <div class="skeleton 2 w-full h-170 rounded-10px bg-coolgray skeleton-animation mt-12px"
