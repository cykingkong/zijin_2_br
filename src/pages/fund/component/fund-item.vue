<template>
  <div>
    ...
    <div
      ...
      <div class="top-li flex items-center" @click="handleClickDetail">
        <div class="l flex flex-shrink-0 items-center gap-6 justify-between ">
          <div class="name font-size-16 font-700 text-#0F172A">{{ item.name }} <svg width="12" height="12"
    ...
    <div
      ...
      <div class="top-li flex items-center text-#5126B5">
        <div class="l flex flex-shrink-0 items-center gap-6 justify-between ">
      ...
      <div class="li flex justify-between items-center text-#717680">
        <div class="li-l font-size-16 ">
          ...
          {{ _item.totalProfit }} / {{ _item.assetInfo.unit }}
          {{ addCommasToNumber(_item.amount) }}
        </div>
        <div class="li-r font-size-14 text-align-right">
          <div class="rate">{{ t("dailyYield") }}:{{ _item.dailyYield }}%</div>
          <div class="rate">
      ...
      <div class="li flex items-center justify-between">
        <div class="li-l text-10px text-#A3A7AE">{{ dayjs(_item.statusTime).format("DD/MM/YYYY ") }}</div>
        <div class="li-r text-10px text-#A3A7AE">{{ dayjs(_item.endTime).format("DD/MM/YYYY ") }}</div>
      </div>
