  ...
  <div class="bankAccount p-24 pb-120">
    <div class="cell-box flex flex-col gap-[16px]">
      <div
        ...
        v-for="(item, index) in bankListData" :key="index" @click="radioActive = index">
        <div class="left flex items-center h-40 gap-[12px]">
          <div class="w-40 h-40 flex items-center justify-center flex-shrink-0 block bg-[#6B39F4] rounded-full" alt="">
        ...
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" v-else>
          <rect x="0.5" y="0.5" width="19" height="19" rx="9.5" stroke="#6B39F4" />
          <rect x="3.33325" y="3.3335" width="13.3333" height="13.3333" rx="6.66667" fill="#6B39F4" />
        </svg>
      </div>
    ...
    <div class="w-full bottom-btn bg-[#FFF] mt-[24px] fixed left-0 px-[24px]">
      <van-button type="primary" color="#6B39F4" block @click="handleClickConfirm">
