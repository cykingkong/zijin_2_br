<template>
    ...
    <div class="order-item-content w-full px-12 py-24  font-size-16 flex flex-col gap-12px"
        ...
        <div class="li flex items-center justify-between">
            <div class="li-l">{{ dayjs(_item.dividendInfo.startTimeEnd).format('DD/MM/YYYY ') }}</div>
            <div class="li-m">——</div>
            <div class="li-r">{{ _item.dividendOrderInfo ? dayjs(_item.dividendOrderInfo?.endTime).format('DD/MM/YYYY ')
                : '-'
            }}</div>
        </div>
        <div class="l flex flex-[2] flex-shrink-0 items-center gap-6">
