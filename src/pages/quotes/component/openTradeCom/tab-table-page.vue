<template>
  <div class="tab-table-table-page px-12 py-12 pb-60px">
    <div
      class="th font-size-14px flex flex-items-center text-align-center font-500"
    >
      <div
        class="th-item px-12"
        :class="
        ...
        "
        v-for="(item, index) in props.tableTh"
        :key="index"
      >
        {{ t(item) }}
      </div>
    ...
    <block v-if="props.tdType === 1">
      <div
        class="td font-size-14px flex flex-items-center text-align-center font-extralight py-12"
        v-for="(e, index) in props.tableData"
        :key="index"
      >
